...
@Module({
  imports: [
    ...
    // WorkspaceCreated to seed each new workspace's default pipeline. Phase 2: the account module
    // (Account + Contact + relationship + erasure). More CRM modules wire in here as later phases
    // add HTTP surfaces.
    CrmAccountModule,
    CrmDealModule,
    HealthModule,
